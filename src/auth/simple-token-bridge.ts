 ...
 *
 * @deprecated This bridge is no longer used in the main plugin flow.
 * SimpleToken now generates complete token packages that are imported via copy-paste,
 * eliminating the need for filesystem access. This ensures cross-platform compatibility
