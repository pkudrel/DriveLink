...
export class DriveLinkSettingTab extends PluginSettingTab {
    ...
    private addAuthenticationSection(containerEl: HTMLElement): void {
        ...
        containerEl.createEl('p', {
            cls: 'setting-item-description',
            text: 'Import tokens generated by the SimpleToken CLI to connect DriveLink to Google Drive.'
        });
        ...
        containerEl.createEl('h4', { text: 'SimpleToken import' });
        containerEl.createEl('p', {
            cls: 'setting-item-description',
            text: 'Run the SimpleToken CLI once and paste its JSON output below. DriveLink will store the tokens for ongoing use.'
        });
