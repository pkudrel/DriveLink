...
export class DriveLinkSettingTab extends PluginSettingTab {
    ...
    private addAuthenticationSection(containerEl: HTMLElement): void {
        ...
        const descEl = containerEl.createEl('p', {
            cls: 'setting-item-description',
            text: 'Import tokens generated by SimpleToken CLI to authenticate with Google Drive.'
        });
    ...
    private addTokenImport(containerEl: HTMLElement): void {
        ...
        new Setting(containerEl)
            .setName('Import Tokens')
            .setDesc('Paste the JSON output from SimpleToken CLI below')
            .addTextArea(text => {
